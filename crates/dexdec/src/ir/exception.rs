...
impl<'a> ExceptionAnalyzer<'a> {
    ...
    pub fn analyze(&self) -> Result<ExceptionAnalysis, ExceptionInvariantError> {
        ...
        let t2c = crate::timing::Instant::now();
        ...
        let t3 = crate::timing::Instant::now();
        ...
        let t4 = crate::timing::Instant::now();
